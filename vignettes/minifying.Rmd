...
`{minifyer}` is a `{shiny}` application that helps minifying css, html, javascript and JSON files. It relies on the `{minifyr}` package, which is a wrapper around `node-minify`.
